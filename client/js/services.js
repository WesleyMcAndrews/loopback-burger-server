      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/UserCredentials/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Customers.credentials.findById() instead.
            "::findById::customers::credentials": {
              params: {
                'fk': '@fk',
              },
            ...
            // INTERNAL. Use Customers.credentials.destroyById() instead.
            "::destroyById::customers::credentials": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/customers/:id/credentials/:fk",
            ...
            // INTERNAL. Use Customers.credentials.updateById() instead.
            "::updateById::customers::credentials": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/customers/:id/credentials/:fk",
            ...
            // INTERNAL. Use Customers.credentials() instead.
            "::get::customers::credentials": {
              isArray: true,
              url: urlBase + "/customers/:id/credentials",
              method: "GET",
            },

            // INTERNAL. Use Customers.credentials.create() instead.
            "::create::customers::credentials": {
              url: urlBase + "/customers/:id/credentials",
              method: "POST",
            },

            // INTERNAL. Use Customers.credentials.createMany() instead.
            "::createMany::customers::credentials": {
              isArray: true,
              url: urlBase + "/customers/:id/credentials",
              method: "POST",
            },

            // INTERNAL. Use Customers.credentials.destroyAll() instead.
            "::delete::customers::credentials": {
              url: urlBase + "/customers/:id/credentials",
              method: "DELETE",
            },

            // INTERNAL. Use Customers.credentials.count() instead.
            "::count::customers::credentials": {
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/UserIdentities/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Customers.identities.findById() instead.
            "::findById::customers::identities": {
              params: {
                'fk': '@fk',
              },
            ...
            // INTERNAL. Use Customers.identities.destroyById() instead.
            "::destroyById::customers::identities": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/customers/:id/identities/:fk",
            ...
            // INTERNAL. Use Customers.identities.updateById() instead.
            "::updateById::customers::identities": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/customers/:id/identities/:fk",
            ...
            // INTERNAL. Use Customers.identities() instead.
            "::get::customers::identities": {
              isArray: true,
              url: urlBase + "/customers/:id/identities",
              method: "GET",
            },

            // INTERNAL. Use Customers.identities.create() instead.
            "::create::customers::identities": {
              url: urlBase + "/customers/:id/identities",
              method: "POST",
            },

            // INTERNAL. Use Customers.identities.createMany() instead.
            "::createMany::customers::identities": {
              isArray: true,
              url: urlBase + "/customers/:id/identities",
              method: "POST",
            },

            // INTERNAL. Use Customers.identities.destroyAll() instead.
            "::delete::customers::identities": {
              url: urlBase + "/customers/:id/identities",
              method: "DELETE",
            },

            // INTERNAL. Use Customers.identities.count() instead.
            "::count::customers::identities": {
 ...
 */
  module.factory(
    ...
    /**
     * @ngdoc object
     * @name lbServices.Customers.identities
     * @header lbServices.Customers.identities
     * @object
     * @description
     *
     * The object `Customers.identities` groups methods
     * manipulating `UserIdentity` instances related to `Customers`.
     *
     * Call {@link lbServices.Customers#identities Customers.identities()}
     * to query all related instances.
     */
             ...
             * @description
             *
             * Queries identities of customers.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - User id
        ...
        R.identities = function() {
          ...
          var action = TargetResource["::get::customers::identities"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Customers.identities#count
             * @methodOf lbServices.Customers.identities
             *
             * @description
             *
             * Counts identities of customers.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - User id
        ...
        R.identities.count = function() {
          var TargetResource = $injector.get("UserIdentity");
          var action = TargetResource["::count::customers::identities"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Customers.identities#create
             * @methodOf lbServices.Customers.identities
             *
             * @description
             *
        ...
        R.identities.create = function() {
          var TargetResource = $injector.get("UserIdentity");
          var action = TargetResource["::create::customers::identities"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Customers.identities#createMany
             * @methodOf lbServices.Customers.identities
             *
             * @description
             *
        ...
        R.identities.createMany = function() {
          var TargetResource = $injector.get("UserIdentity");
          var action = TargetResource["::createMany::customers::identities"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Customers.identities#destroyAll
             * @methodOf lbServices.Customers.identities
             *
             * @description
             *
        ...
        R.identities.destroyAll = function() {
          var TargetResource = $injector.get("UserIdentity");
          var action = TargetResource["::delete::customers::identities"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Customers.identities#destroyById
             * @methodOf lbServices.Customers.identities
             *
             * @description
             *
        ...
        R.identities.destroyById = function() {
          var TargetResource = $injector.get("UserIdentity");
          var action = TargetResource["::destroyById::customers::identities"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Customers.identities#findById
             * @methodOf lbServices.Customers.identities
             *
             * @description
             *
        ...
        R.identities.findById = function() {
          var TargetResource = $injector.get("UserIdentity");
          var action = TargetResource["::findById::customers::identities"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Customers.identities#updateById
             * @methodOf lbServices.Customers.identities
             *
             * @description
             *
        ...
        R.identities.updateById = function() {
          var TargetResource = $injector.get("UserIdentity");
          var action = TargetResource["::updateById::customers::identities"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Customers.credentials
     * @header lbServices.Customers.credentials
     * @object
     * @description
     *
     * The object `Customers.credentials` groups methods
     * manipulating `UserCredential` instances related to `Customers`.
     *
     * Call {@link lbServices.Customers#credentials Customers.credentials()}
     * to query all related instances.
     */
             ...
             * @description
             *
             * Queries credentials of customers.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - User id
        ...
        R.credentials = function() {
          ...
          var action = TargetResource["::get::customers::credentials"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Customers.credentials#count
             * @methodOf lbServices.Customers.credentials
             *
             * @description
             *
             * Counts credentials of customers.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - User id
        ...
        R.credentials.count = function() {
          var TargetResource = $injector.get("UserCredential");
          var action = TargetResource["::count::customers::credentials"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Customers.credentials#create
             * @methodOf lbServices.Customers.credentials
             *
             * @description
             *
        ...
        R.credentials.create = function() {
          var TargetResource = $injector.get("UserCredential");
          var action = TargetResource["::create::customers::credentials"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Customers.credentials#createMany
             * @methodOf lbServices.Customers.credentials
             *
             * @description
             *
        ...
        R.credentials.createMany = function() {
          var TargetResource = $injector.get("UserCredential");
          var action = TargetResource["::createMany::customers::credentials"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Customers.credentials#destroyAll
             * @methodOf lbServices.Customers.credentials
             *
             * @description
             *
        ...
        R.credentials.destroyAll = function() {
          var TargetResource = $injector.get("UserCredential");
          var action = TargetResource["::delete::customers::credentials"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Customers.credentials#destroyById
             * @methodOf lbServices.Customers.credentials
             *
             * @description
             *
        ...
        R.credentials.destroyById = function() {
          var TargetResource = $injector.get("UserCredential");
          var action = TargetResource["::destroyById::customers::credentials"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Customers.credentials#findById
             * @methodOf lbServices.Customers.credentials
             *
             * @description
             *
        ...
        R.credentials.findById = function() {
          var TargetResource = $injector.get("UserCredential");
          var action = TargetResource["::findById::customers::credentials"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Customers.credentials#updateById
             * @methodOf lbServices.Customers.credentials
             *
             * @description
             *
        ...
        R.credentials.updateById = function() {
          var TargetResource = $injector.get("UserCredential");
          var action = TargetResource["::updateById::customers::credentials"];
          return action.apply(R, arguments);
        };
